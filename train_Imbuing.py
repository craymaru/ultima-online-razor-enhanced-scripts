...
def imbuingItem(item_id):
    ...
    while Items.FindByID(item_id, 0x0000, Player.Backpack.Serial):
        ...
        getContainerItem(magical_residue_id, 0x0000, 100, 200, 0x400D3E1F)
        ...
        if item:
            ...
            # DISPEL
            if not propMatch(item, "^hit dispel \d+%$"):
                Player.HeadMessage(77, "DO DISPEL!")
...
while True:
    ...
    getContainerItem(ingot_id, ingot_hue, 100, 200, 0x400CA97E)
    
    
    while Items.ContainerCount(Player.Backpack.Serial, itemToCraft.itemID, 0x0000) < 5:
    ...
    imbuingItem(itemToCraft.itemID)




Gumps.WaitForGump(2270339787, 10000)
Gumps.SendAction(2270339787, 0)
Gumps.WaitForGump(1697188745, 10000)
Gumps.SendAction(1697188745, 10005)
Target.WaitForTarget(10000, False)
Target.TargetExecute(0x400B9A79)
